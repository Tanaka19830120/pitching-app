        ...
        <div className="bg-white rounded-2xl shadow-sm p-4 space-y-4">
          <div>
            ...
            <input
              ...
              onChange={e => set('practiced_at', e.target.value)}
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                onChange={e => set('avg_speed', e.target.value)}
                placeholder="例: 78"
                min="1" max="200"
                className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-gray-800 focus:outline-none focus:ring-2 focus:ring-green-400"
              />
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                type="number"
                value={form.total_pitches}
                onChange={e => set('total_pitches', e.target.value)}
                required
                placeholder="例: 50"
                min="1"
                className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-gray-800 focus:outline-none focus:ring-2 focus:ring-green-400"
            ...
            <div>
              ...
              <input
                ...
                onChange={e => set('strike_count', e.target.value)}
                placeholder="例: 35"
                min="0"
                className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-gray-800 focus:outline-none focus:ring-2 focus:ring-green-400"
              />
            ...
            {PITCH_TYPES.map(type => (
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-sm font-medium transition-colors ${
                  form.pitch_types.includes(type)
